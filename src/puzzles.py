...
from chess import render_chess
...
description_map = {
    ...
    'crossword': 'Fill the blank squares with letters to form words that cross each other, by solving clues in the "Across" and "Down" columns.'
}
takuzu_map = {
    '0': "o",
    '1': "x"
...
def print_puzzle(puzzle_dict, printer):
    ...
    if puzzle_type == 'anagram':
        ...
        draw_wordwheel(puzzle_data["task"], output_file="puzzle.png")
        printer.image('puzzle.png', impl='graphics', center=True)
